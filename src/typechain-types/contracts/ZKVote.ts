...
export interface ZKVoteInterface extends utils.Interface {
  functions: {
    ...
    "registerCommitment(uint256,uint256,address)": FunctionFragment;
    ...
    "vote(uint256,uint256,uint256,uint256[2],uint256[2][2],uint256[2])": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "getVoti", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "getVoti", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "hashLeftRight",
    data: BytesLike
  ): Result;
...
export interface ZKVote extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZKVoteInterface;
  ...
  functions: {
    ...
    getVoti(overrides?: CallOverrides): Promise<[BigNumber[]]>;
  ...
  populateTransaction: {
    ...
    getVoti(overrides?: CallOverrides): Promise<PopulatedTransaction>;
